...
_.extend(SDKPackage.prototype, {
  /**
  * Retrives the list of files from the sdk
  ...
  */
  getFiles: function (callback) {
    ...
    function getFilesNames () {
      callback(null, Object.keys(self.manifest.files).map(function (f) {
        return self.manifest.files[f].name;
      }));
    }
  ...
  /*
  * Retrives the data from a file from the SDK.
  *
