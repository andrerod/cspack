...
_.extend(Package.prototype, {
  ...
  */
  addLayoutDefinition: function (layoutName, callback) {
    ...
    if (!self.pkg.PackageLayouts) {
      self.pkg.PackageLayouts = { LayoutDefinition: [ layoutDefinition ] };
    } else {
  ...
  *
  * @param {function(err, package)} callback The callback function.
  */
  save: function (callback) {
    ...
    self.dataStore.addContentFromBuffer(constants.PackagePaths.PackageManifest,
      self.viewEngine.render(path.join(__dirname, 'templates', constants.TemplatePaths.PackageManifest), self.pkg),
      function (err) {
        if (err) { return callback(err); }

        self.dataStore.save(callback);
      });
  },
  ...
  */
  getContentStat: function (dataStorePath, callback) {
    return this.dataStore.getContentStat(dataStorePath, callback);
  },
  ...
  */
  getContent: function (dataStorePath, callback) {
    return this.dataStore.getContents(dataStorePath, callback);
  },
  ...
  */
  getContents: function (callback) {
    return this.dataStore.getContents(callback);
  },
  ...
  */
  addContent: function (name, origin, callback) {
    return this.dataStore.addContent(name, origin, callback);
  }
});
