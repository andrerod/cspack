...
_.extend(CsPack.prototype, {
  ...
  addRoles: function (callback) {
    ...
    function createRole(roleName, cb) {
      ...
      function addBaseFiles (baseFiles, cb) {
        if (baseFiles.length > 0) {
          var file = baseFiles.pop();
          var fullPath = null;
          if (!_.isObject(file)) {
        ...
        utils.getFilesDirectory(path.join(self.inputDirectory, roleName), function (err, files) {
          if (err) {
            ...
            case constants.RoleTypes.Worker:
              ...
              processWorkerRoleTemplate('LocalContent', 'Roles/WorkerRole/Cloud.uar.csman.handlebars', roleData, false, function () {
                processWorkerRoleTemplate('LocalContent', 'Roles/WorkerRole/RoleModel.xml.handlebars', roleData, false, function () {
                  processWorkerRoleTemplate('LocalContent', 'Roles/WorkerRole/RuntimeSetup.Manifest.handlebars', roleData, false, function () {
